...
void MeshBlock::InitUserMeshBlockData(ParameterInput *pin) {
  ...
  SetUserOutputVariableName(4 + NVAPOR + 1, "lH2Oamd");
  SetUserOutputVariableName(4 + NVAPOR + 2, "sH2Oamd");
  SetUserOutputVariableName(4 + NVAPOR + 3, "lH2Ogel");
  SetUserOutputVariableName(4 + NVAPOR + 4, "sH2Ogel");
}
